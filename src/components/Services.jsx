...
import { BASE_URL } from '../lib/assetManifest'
...
const SERVICES = [
    {
        ...
        title: '3D Animation',
        description:
            'We craft high-fidelity 3D animations that blur the line between virtual and reality. Specializing in automotive cinematography, we use Unreal Engine 5 to deliver photorealistic lighting, physics-based driving dynamics, and emotional storytelling. Whether it\'s a commercial spot or a brand launch, we make sure the machine has a soul.',
        video: `${BASE_URL}/assets/home_page/service_cards/01_3d_animation.mp4`,
        poster: `${BASE_URL}/assets/works/01_BMW/01.jpg`,
    },
    {
        id: 2,
        title: 'CGI & Mixed Reality',
        description:
            'Seamlessly blend live-action footage with computer-generated elements. We create viral-ready Mixed Reality content that puts virtual cars into real-world streets or transforms ordinary footage into a digital dreamscape. Perfect for high-impact social media content and VFX-heavy commercials that need to break the laws of physics.',
        video: `${BASE_URL}/assets/home_page/service_cards/02_cgi_mix_reality.mp4`,
        poster: `${BASE_URL}/assets/works/03_mustang/01.png`,
    },
    {
        id: 3,
        ...
        video: `${BASE_URL}/assets/home_page/service_cards/01_3d_animation.mp4`,
        poster: `${BASE_URL}/assets/works/05_porche/01.jpg`,
    },
    {
        id: 4,
        title: 'Unreal Engine Configurators',
        description:
            "Don't just show the car—let them drive it. We build fully interactive 3D Car Configurators using Unreal Engine (Pixel Streaming). Users can change paint colors, swap wheels, trigger animations, and explore detailed interiors in real-time 4K. It's not just a video; it's a digital showroom that runs anywhere.",
        video: `${BASE_URL}/assets/home_page/service_cards/01_3d_animation.mp4`,
        poster: `${BASE_URL}/assets/works/04_yatch/01.jpg`,
    },
    {
        id: 5,
        ...
        video: `${BASE_URL}/assets/home_page/service_cards/02_cgi_mix_reality.mp4`,
        poster: `${BASE_URL}/assets/works/06_game_env/01.jpg`,
    },
]
    ...
    return (
        <section className="relative w-full bg-transparent pt-24 pb-48 px-4 md:px-12 flex flex-col items-center">
            <div className="w-full max-w-7xl mb-24">
                ...
                <div className="h-1 w-24 bg-gradient-to-r from-indigo-500 to-transparent" />
            </div>
            ...
            <div className="w-full max-w-7xl flex flex-col gap-12 lg:gap-24">
                {SERVICES.map((service, i) => (
                    ...
                    >
                        <div className="relative w-full max-w-7xl h-auto lg:h-[70vh] lg:min-h-[600px] bg-[#111]/80 backdrop-blur-md rounded-none border border-white/10 overflow-hidden shadow-2xl flex flex-col lg:flex-row z-10">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col justify-center items-start z-10 p-6 md:p-8 lg:p-12">
                                ...
                                <button
                                    type="button"
                                    className="px-6 py-2 lg:px-8 lg:py-3 rounded-none border border-white/20 text-white text-sm font-medium hover:bg-white hover:text-black transition-all duration-300"
                                >
                                    Learn More
                                </button>
                            </div>
